...
<body style="font-family: Arial, sans-serif; background-color: #fbf7f2; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
        ...
        <p style="color: #7b6858; line-height: 1.6;">Halo,</p>
        <p style="color: #7b6858; line-height: 1.6;">Kami menerima permintaan untuk mereset password akun Anda di Velora. Jika Anda tidak merasa melakukan permintaan ini, Anda dapat mengabaikan email ini.</p>
        ...
        <p style="color: #b79f8a; font-size: 12px; text-align: center;">&copy; {{ date('Y') }} Velora. All rights reserved.</p>
    </div>
</body>
</html>
