...
<style>
    ...
    /* Hide scrollbars for dynamic horizontal product slider */
...
<div id="cart-toast"
    ...
    <div
        class="flex min-w-[320px] max-w-[360px] items-start gap-3 rounded-[24px] bg-[#fffaf6] px-5 py-4 shadow-[0_24px_60px_rgba(92,68,50,0.18)]" style="border:none;outline:none;">
...
<section class="mx-auto max-w-7xl px-6 pb-12">
    <div class="mb-8 flex items-center gap-4">
        ...
        <a href="{{ route('product') }}?category=semua"
            class="mt-2 text-sm font-semibold text-[#5c4432] no-underline transition hover:text-[#8f7561] hover:underline">
            Lihat semua
        </a>
    </div>
    ...
    <div id="product-slider"
        class="flex gap-7 overflow-x-auto scroll-smooth snap-x snap-mandatory pb-4 cursor-grab active:cursor-grabbing"
        style="-ms-overflow-style: none; scrollbar-width: none;">
        @foreach ($products as $index => $product)
        <div class="w-[280px] sm:w-[calc((100%-28px)/2)] lg:w-[calc((100%-84px)/4)] shrink-0 snap-start">
...
<script>
    ...
    function addToCart() {
        ...
        const fields = {
            ...
            stok_id: currentProduct.stok_ids ? currentProduct.stok_ids[selectedSize] : ''
        };
